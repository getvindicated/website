...
function EngineDiagram() {
  ...
  return (
    <div
      className="border-b bg-[var(--color-bg-surface)] border-[var(--color-border)]"
    >
      <div
        className="px-16 py-14 border-b max-md:px-6 border-[var(--color-border)]"
      >
        <p
          className="text-[0.78rem] font-semibold mb-2 text-[var(--color-accent)]"
        >
      ...
      <div
        className="grid grid-cols-[1fr_420px] h-[700px] max-lg:grid-cols-1"
      >
        {/* Image + pins */}
        <div
          className="relative overflow-hidden bg-[var(--color-bg-surface)]"
        >
          <Image
        ...
        {/* Panel */}
        <div
          className="flex flex-col border-l overflow-hidden max-lg:border-l-0 max-lg:border-t bg-[var(--color-bg-page)] border-[var(--color-border)]"
        >
          {/* Legend */}
          <div
            className="flex flex-wrap gap-3 px-6 py-4 border-b text-[0.72rem] bg-[rgba(0,0,0,0.2)] border-[var(--color-border)]"
          >
            {Object.entries(colorMap).map(([key, val]) => (
              <span
                key={key}
                className="flex items-center gap-1 text-[rgba(255,255,255,0.7)]"
              >
                <span
          ...
          {!active ? (
            ...
            <div className="flex flex-col flex-1 overflow-hidden slide-up">
              <div
                className="px-7 py-6 border-b bg-[var(--color-bg-surface)] border-[var(--color-border)]"
              >
                <span
              ...
              <div className="px-7 py-5 flex-1 overflow-y-auto space-y-4 scrollbar-none">
                <div>
                  <p
                    className="text-[0.75rem] font-bold uppercase tracking-[0.06em] mb-2 text-[var(--color-accent)]"
                  >
                    What it is
                  </p>
                ...
                <div>
                  ...
                  <ol className="list-none space-y-3">
                    {card.steps.map((step, i) => (
                      ...
                      >
                        <span
                          className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 text-[0.6rem] font-bold text-white bg-[var(--color-vivid)]"
                        >
                          {i + 1}
                        </span>
                        {step}
                ...
                {card.flag2 && (
                  <div
                    className="py-3 px-4 text-[1.05rem] leading-[1.75] border-l-[3px] border-l-[var(--color-gold)] bg-[rgba(201,168,76,0.08)] text-[var(--color-gold)]"
                  >
                    {card.flag2}
                  </div>
                )}
              ...
              {/* Nav dots */}
              <div
                className="flex flex-wrap gap-1 px-7 py-3 border-t border-[var(--color-border)] bg-[rgba(90,48,105,0.04)]"
              >
                {enginePins.map((p) => (
                  <button
                    key={p.id}
    ...
    <>
        ...
        >
          ...
          >
            ...
            <div className="space-y-5">
              ...
              <div
                className="p-6 bg-[rgba(214,59,59,0.08)] border border-[rgba(214,59,59,0.3)] border-l-[4px] border-l-[var(--color-red)]"
              >
                <p
                  className="text-[0.82rem] font-bold uppercase tracking-[0.04em] mb-3 text-[var(--color-accent)]"
                >
              ...
              <div
                className="py-4 px-5 bg-[rgba(214,59,59,0.08)] border-l-[3px] border-l-[var(--color-red)]"
              >
                <p
                  className="text-[1.05rem] leading-[1.75] text-[#ffb0b0]"
                >
                  <strong>
      ...
      <FadeUp>
        ...
        >
          ...
          <div
            className="grid gap-[1.5px] grid-cols-4 max-md:grid-cols-2 bg-[#000]"
          >
            {brands.map((brand) => (
              <Link
                key={brand.name}
                ...
                className="flex flex-col items-center gap-4 p-8 no-underline transition-colors duration-200 group relative overflow-hidden bg-[#000]"
                onMouseEnter={(e) => {
              ...
              >
                ...
                <div
                  className="absolute bottom-0 left-0 right-0 h-[2px] scale-x-0 group-hover:scale-x-100 transition-transform duration-200 origin-left bg-[var(--color-vivid)]"
                />
              </Link>
            ))}
          </div>
